...
echo "To deploy the 'kubelet-cpu' sample only: kubectl kustomize test/samples/overlays/kind | kubectl apply -f - --selector=sample=kubelet-cpu"
echo "To deploy all samples: kubectl apply -k test/samples/overlays/kind"
